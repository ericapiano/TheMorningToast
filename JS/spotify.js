const spotify_CLIENT = "b2e9632653534d3fa494ab4d964ea296";
...
function spotifyLogin() {
  ...
  console.log()
  const redirect_uri = "http://localhost:5500/spotify.html"; 
...
//spotify:user:1254120540:playlist:6FkQYQPUSqLBWRdcIlelMz
// get the morning breakfast playlist
function getBreakfastPlaylist() {
  $.ajax({
    url: "https://api.spotify.com/v1/users/1254120540/playlists/6FkQYQPUSqLBWRdcIlelMz/tracks",
    method: "GET",
    headers: {
      'Authorization': "Bearer " + access_token
    }
...
$(document)
  .ready(function () {
    ...
    getCategories();
    $("#user-playlists").on("click", getBreakfastPlaylist);
